...
idf_folderpath = '../../../data/idf/frassinetto_casestudy_3archs'
config = {
    "idf_file": "../../../data/idf/frassinetto_casestudy/SingleFamilyHouse_2.idf",
    "idd_file": "/usr/local/EnergyPlus-23-1-0/Energy+.idd",
    "weather": "../../../data/meteo_file/meteo_bousson.epw",
    "FMI_v": "2.0",
