...
#nC = fmu.getInteger([vrs['TBuilding']])[0]
...
while time < stop_time:
	...
	for v in inputs:
		fmu.setReal([v.valueReference], [20.0 if time < stop_time / 2 else 10.0])
...
# plot the results
plt.plot(result['time'], result['TBuilding'])